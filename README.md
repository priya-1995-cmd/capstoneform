...
## Environments
- Preview: https://main--capstoneform--priya-1995-cmd.hlx.page/
- Live: https://main--capstoneform--priya-1995-cmd.hlx.live/
...
1. Open the `capstoneform` directory in your favorite IDE and start coding :)
